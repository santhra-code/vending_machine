  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-200 via-pink-100 to-pink-200 px-4 py-10">
      <div className="mx-auto max-w-lg rounded-3xl bg-white/70 shadow-xl backdrop-blur p-8">
        ...
        <p className="mt-2 text-center text-pink-800/70">
          Placeholder QR screen. Razorpay will be integrated later.
        </p>
          ...
          <>
            ...
            <div className="mt-8 rounded-2xl bg-pink-50 border border-pink-200 p-6">
              ...
              <div className="mt-6 flex items-center justify-center">
                <div className="h-56 w-56 rounded-2xl bg-white border-2 border-dashed border-pink-300 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-lg font-bold text-pink-700">QR</div>
                    <div className="text-sm text-pink-700/70">
                      (placeholder)
                    </div>
                  </div>
                </div>
